...
class SearchFilterTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.emt.tags.add(cls.outdoor_tag)
...
class ProductListViewTests(TestCase):
    ...
    def setUpTestData(cls):
        category = Category.objects.create(name="Cat", slug="cat")
        for index in range(ProductSearch.PAGE_SIZE + 3):
    ...
    def test_first_page_is_full(self):
        ...
        self.assertEqual(len(page_obj), ProductSearch.PAGE_SIZE)
        self.assertEqual(page_obj.paginator.count, ProductSearch.PAGE_SIZE + 3)
